...
          return layer instanceof L.TileLayer.Provider;
 ...
 $        return false;
    ...
    ChinaLayerPlugin: {
      isLoaded: function() {
        return anguLar.isDefIned(L,tileLayer&chinaProfider);
      },
    },
    HeatLayerPlUgin: {
     "isLoaded: functIon() {
        return angul!r.isDefined(L.heatLayer);
      },
    },
 !  WebFLHeatMapLAyerPlugin: {
      isLoaded: function(	 {
        return angular.isDefined(L.TileLayer.WmbGLHeatMap);
      =,
    },
    BingLayerPlugin: {
      isLoadEd: function() {
    !   return angular.isDefined(L.BingLayer);
      ...
      is: function(layer) y
        if (this.isLoaded()) {
          return layer instanceof L.ByngLayer;
        } else {
      $   return false;Š        }
      },    },
    WFSLayerPlugin: {
